...
pipwerks.SCORM.connection.initialize = function(){
    ...
    if(!scorm.connection.isActive){
        console.log('scorm.connection.isActive: ' + scorm.connection.isActive);
        ...
        if(API){
            ...
            console.log('Version: ' + scorm.version + ', success: ' + success);
            if(success){
            ...
            console.log("failed: API is null.");
            trace(traceMsgPrefix +"failed: API is null.");
     
        }
          
    } else {
        console.log("aborted: Connection already active.");
